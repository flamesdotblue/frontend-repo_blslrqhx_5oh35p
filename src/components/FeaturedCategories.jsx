...
const sampleQuizzes = [
  { id: 'q1', title: 'SSC CGL General Awareness', category: 'SSC', difficulty: 'Medium', duration: 20 },
  { id: 'q2', title: 'RRB NTPC Reasoning Set', category: 'RRB', difficulty: 'Easy', duration: 15 },
  { id: 'q3', title: 'Banking Quantitative Aptitude', category: 'Banking', difficulty: 'Hard', duration: 30 },
  { id: 'q4', title: 'Railways GK Booster', category: 'Railways', difficulty: 'Medium', duration: 25 },
  { id: 'q5', title: 'SSC CHSL English Practice', category: 'SSC', difficulty: 'Easy', duration: 10 },
];
...
function QuizCard({ quiz }) {
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-5 backdrop-blur transition hover:translate-y-[-2px]">
      ...
      {/* Non-interactive overlay for guests */}
...
export default function FeaturedCategories() {
  ...
  return (
    <section id="featured" className="relative mx-auto -mt-24 max-w-7xl px-6 pb-20">
